        ...
        <Card className="border-slate-200 shadow-xl">
          <CardHeader className="text-center space-y-4">
            ...
            <div className="space-y-2">
              ...
              <CardDescription className="text-slate-600">Access your dashboard to drive your sales</CardDescription>
            </div>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link href="/forgot-password" className="text-sm text-cyan-800 hover:text-cyan-900 font-medium">
                  Forgot password?
                </Link>
              </div>
            ...
            <div className="text-center text-sm text-slate-600">
              ...
              <Link href="/signup" className="text-cyan-800 hover:text-cyan-900 font-medium">
                Sign up for free
              </Link>
            </div>
          </CardContent>
